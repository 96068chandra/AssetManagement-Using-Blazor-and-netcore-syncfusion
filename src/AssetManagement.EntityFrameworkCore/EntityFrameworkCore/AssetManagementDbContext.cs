    ...
    ITenantManagementDbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        {
            b.ToTable(AssetManagementConsts.DbTablePrefix + "Products", AssetManagementConsts.DbSchema);
            b.ConfigureByConvention();
            b.Property(p => p.Name).IsRequired().HasMaxLength(100);//auto configure for the base class props
            //...
        });
    }
}
